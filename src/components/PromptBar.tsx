            ...
            >
              ...
              {mode === 'search' && value && (
                <button
                  ...
                  className="flex items-center justify-center w-8 h-8 md:w-11 md:h-11 rounded-md bg-white/5 border border-white/10 text-white/40 hover:text-white hover:bg-white/10 transition-all mr-2"
